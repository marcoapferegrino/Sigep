...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        static::translator()->addResource('array', require '/home/vagrant/Code/posgradoService/vendor/nesbot/carbon/src/Carbon' . '/Lang/' . $locale . '.php', $locale);
    }
...
namespace PosgradoService\Providers {
use Illuminate\Support\ServiceProvider;
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $this->app->bind('Illuminate\\Contracts\\Auth\\Registrar', 'PosgradoService\\Services\\Registrar');
    }
}
}
...
class BusServiceProvider extends ServiceProvider
{
    public function boot(Dispatcher $dispatcher)
    {
        $dispatcher->mapUsing(function ($command) {
            return Dispatcher::simpleMapping($command, 'PosgradoService\\Commands', 'PosgradoService\\Handlers\\Commands');
        });
    }
    public function register()
    {
...
class RouteServiceProvider extends ServiceProvider
{
    protected $namespace = 'PosgradoService\\Http\\Controllers';
    public function boot(Router $router)
    {
        parent::boot($router);
    }
